...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      icon: MessageCircle,
      href: "https://wa.me/919787304714?text=Hello! I'm interested in your services.",
      label: "WhatsApp",
    },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2" data-testid="footer-brand">
            <h3 className="text-3xl font-bold mb-4 text-white">Infosense Technology</h3>
            <p className="text-gray-300 mb-6 leading-relaxed max-w-md">
              Building scalable solutions for real problems. We specialize in custom software development, SaaS
              solutions, and enterprise integrations.
            </p>
